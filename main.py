...
# funcion donde pasamos body al api
...
# Edu **Chat**{: .color-primary} # {: .logo-text}
<|Contactar Asesor|button|class_name=fullwidth plain|id=reset_app_button|on_action=reset_chat|>
### Planes de estudio anteriores ### {: .h5 .mt2 .mb-half}
...
if __name__ == "__main__":
    ...
    Gui(page).run(debug=True, dark_mode=True, use_reloader=True, title="💬 EduBot")
